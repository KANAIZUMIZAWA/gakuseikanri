    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('school_grades.update', $school_grades)); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <form method="POST" action="<?php echo e(route('school_grades.destroy', $school_grades)); ?>" class="d-inline">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/practice/resources/views/school_grades/edit.blade.php ENDPATH**/ ?>